        ...
        <div className="footer-main">
          ...
          <div className="footer-brand">
            ...
            <div className="newsletter-section">
              ...
              <p className="newsletter-text">Subscribe to our newsletter for exclusive deals</p>
              <form onSubmit={handleNewsletterSubmit} className="newsletter-form">
                <div className="newsletter-input-wrapper">
                  <input
                    ...
                    className={`newsletter-input ${newsletterStatus === 'error' ? 'error' : ''}`}
                ...
                {newsletterStatus === 'success' && (
                  <span className="newsletter-success">Successfully subscribed!</span>
                )}
          ...
          <div className="footer-column">
            ...
            <p className="download-description">Get the app for better experience</p>
            <div className="footer-download-buttons">
              <a href="#app-store" className="footer-store-btn">
                ...
                <div className="btn-text-footer">
                  <span className="btn-label-footer">Download on</span>
                  <span className="btn-store-footer">App Store</span>
                </div>
              </a>
              <a href="#google-play" className="footer-store-btn">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M3,20.5V3.5C3,2.91 3.34,2.39 3.84,2.15L13.69,12L3.84,21.85C3.34,21.6 3,21.09 3,20.5M16.81,15.12L6.05,21.34L14.54,12.85L16.81,15.12M20.16,10.81C20.5,11.08 20.75,11.5 20.75,12C20.75,12.5 20.5,12.92 20.16,13.19L17.89,14.5L15.39,12L17.89,9.5L20.16,10.81M6.05,2.66L16.81,8.88L14.54,11.15L6.05,2.66Z"/>
                </svg>
                <div className="btn-text-footer">
                  <span className="btn-label-footer">Get it on</span>
                  <span className="btn-store-footer">Google Play</span>
                </div>
              </a>
            </div>

            {/* Social Media */}
            <h4 className="footer-column-title" style={{ marginTop: '30px' }}>Follow Us</h4>
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            <p className="copyright">
              &copy; {new Date().getFullYear()} Book Here. All rights reserved.
            </p>
